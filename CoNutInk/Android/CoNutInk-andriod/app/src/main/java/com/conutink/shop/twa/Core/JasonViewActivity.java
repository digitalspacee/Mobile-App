package com.conutink.shop.twa.Core;
...
import com.conutink.shop.twa.Component.JasonComponentFactory;
import com.conutink.shop.twa.Component.JasonImageComponent;
import com.conutink.shop.twa.Helper.JasonHelper;
import com.conutink.shop.twa.Launcher.Launcher;
import com.conutink.shop.twa.Service.agent.JasonAgentService;
import com.conutink.shop.twa.Service.vision.JasonVisionService;
import com.conutink.shop.twa.Lib.JasonToolbar;
import com.conutink.shop.twa.Lib.MaterialBadgeTextView;
import com.conutink.shop.twa.R;
import com.conutink.shop.twa.Section.ItemAdapter;
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if(sectionLayout == null){
        ...
        System.out.println("Jason View Activity (JasonModel): "+ model.url);
        Uri uri = getIntent().getData();
        System.out.println("Jason View Activity (Uri): "+ uri);
       /* if(uri != null && uri.getHost().contains("oauth")) {
        ...
        if(savedInstanceState != null) {
            ...
            try {
                ...
                model.url = url;
                System.out.println("Jason View Activity (Model.url): "+ model.url);
            ...
            if (head.has("agents")) {
                ...
                while (iterator.hasNext()) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                System.out.println("Run Setup Agents");
    ...
    private void onRefresh() {
        ...
        System.out.println("Contains Signature: "+pref.contains(signature));
        if(pref.contains(signature))
        {
            ...
            if (preload != null)
            {
                System.out.println("Preload Null??: "+preload);
                setup_body(preload);
            }
        }
    ...
    private void onSwitchTab(String newUrl, String newParams, Intent intent) {
        ...
        try {
          ...
          //  clear_agents();
            ...
            System.out.println("JasonMOdedL: "+m);
