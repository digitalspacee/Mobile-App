package sg.aurumlife.app.Component;
...
import sg.aurumlife.app.Action.JasonGeoAction;
                    ...
                    public void onInfoWindowClick(Marker marker) {
                        try {
                            ...
                            if (pinJSONObject.has(ACTION_PROP)) {
                                ...
                                pinData.put(MAP_PIN_COORD_PROP, String.format(JasonGeoAction.COORDS_STRING_FORMAT
