...
didFinishLaunchingWithOptions:(nullable NSDictionary *)launchOptions {
  ...
  [OneSignal setAppId:@"961513bd-5a8a-4bdd-b972-8cd2bfdc33ce"];
  ...
  [OneSignal setExternalUserId:@"Wellness365 One Signal"];
    
    return ready && [self.extensions application:application didFinishLaunchingWithOptions:launchOptions] && YES;
}
